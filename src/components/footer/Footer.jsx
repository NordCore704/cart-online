...
const Footer = () => {
  ...
  return (
    <footer className="foot border-y border-black h-[50vh]  relative mt-60 flex flex-col gap-4 items-center justify-end bg-periwinkle p-5">
      ...
      <div
        className={`links-foot flex gap-4 items-center justify-center ${inter.className}`}
      >
        <Link
          href={"/"}
          className={
            currentRoute === "/"
              ? "active"
              : `font-semibold text-black hover:text-schemeRed transition`
          }
        >
          Home
        </Link>
        <Link
          href={"/about-us"}
          className="font-semibold text-black hover:text-schemeRed transition"
        >
          About Us
        </Link>
        <Link
      ...
      <p
        className={`text-lg uppercase text-black font-semibold ${poppins.className}`}
      >
        Our Socials
      </p>
